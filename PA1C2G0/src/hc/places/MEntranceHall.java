...
public class MEntranceHall implements IWaitingHall, ICallCenterWaiter {
     ...
     */
    public MEntranceHall(HCInstance instance, IContainer after, int seatsPerRoom, int adults, int children,
            int nextRoomSlack) {
    ...
    /**
     * @return mapping of contained room names to patient name array, one key per
     *         room
     */
    @Override
    ...
    /**
     * Due to patient thread pooling this function can be empty, if we had any
     * workers we'd have to pause them
     */
    @Override
    public void suspend() {
    ...
    /**
     * Identifies "oldest" child patient in queue if they exist and tells them to
     * leave, updates containment state
     */
    ...
    /**
     * Identifies "oldest" adult patient in queue if they exist and tells them to
     * leave, updates containment state
     */
     ...
     * 
     * @param releasedRoom the type of room that was released, anything except EVH
     ...
     * signal Call Center this function only notifies instance to log changes
     * 
