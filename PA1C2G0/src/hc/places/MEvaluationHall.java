...
public class MEvaluationHall implements IHall {
     ...
     * <p>
     * If a patient has been allowed in here at all there IS an available room
     * therefore there is no need to halt them
     * 
     ...
     * 
     * @return a map linking room name to list of patients inside with length 1, may
     *         contain null
     */
    @Override
     ...
     * <p>
     * Room availability has already been changed to false, as such this method only
     * needs to do logging
     * 
